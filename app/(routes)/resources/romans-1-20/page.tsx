    ...
    <>
      ...
      <main className="flex flex-col">
        ...
        <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pb-12">
          <div className="  max-w-none text-[#31261d]">
          ...
          <div className="prose max-w-none text-[#31261d]">
            <p>
              At UGUIDE, we believe that being in nature is one of the best ways
              to experience the real living presence of God by enjoying His
              natural creation.
            </p>
            <p>
              To get a taste of divine nature at a{" "}
              <Link href="/availability" className="text-[#E4803A] underline">
                UGUIDE South Dakota Pheasant Hunt
              </Link>
              , check availability of our packages here.
            </p>
          </div>
        </section>
      </main>
