...
export default function ContactPage() {
  ...
  const getHuntTypeLabel = (type: string) => {
    ...
    if (type === "Fully Guided (Professional Guide + Trained Dogs)")
      return "Fully Guided";
    return type;
  };
                ...
                <div className="flex flex-1 flex-col gap-1 sm:flex-row sm:items-center sm:gap-4">
                  ...
                  <div className="flex flex-wrap items-center gap-2 text-sm">
                    ...
                    <span className="text-black/60">
                      {submission.minGroupSize}-{submission.maxGroupSize}{" "}
                      hunters
                    </span>
                  </div>
                </div>
                    ...
                    <div>
                      ...
                      <div className="mt-1 space-y-1 text-sm">
                        ...
                        <p>
                          ...
                          <span className="font-medium text-black">
                            {submission.experience || "Not specified"}
                          </span>
                        </p>
                        <p>
                          <span className="text-black/50">Group Size:</span>{" "}
                          <span className="font-medium text-black">
                            {submission.minGroupSize} -{" "}
                            {submission.maxGroupSize} hunters
                          </span>
                        </p>
                        <p>
                          <span className="text-black/50">Dog Power:</span>{" "}
                          <span className="font-medium text-black">
                            {submission.dogPower || "Not specified"}
                          </span>
                        </p>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="mt-1 space-y-1 text-sm">
                        <p>
                          ...
                          <span className="font-medium text-black">
                            {submission.firstChoice || "Not selected"}
                          </span>
                        </p>
                        <p>
                          <span className="text-black/50">2nd Choice:</span>{" "}
                          <span className="font-medium text-black">
                            {submission.secondChoice || "Not selected"}
                          </span>
                        </p>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="mt-1 space-y-1 text-sm">
                        ...
                        <p>
                          ...
                          <span className="font-medium text-black">
                            {submission.stateProvince || "Not specified"}
                          </span>
                        </p>
                      </div>
                    </div>
