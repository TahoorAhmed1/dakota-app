...
const fieldClassName =
  "h-[45px] w-full rounded-[2px] rounded-xl border border-[#9d9d9d] bg-white px-3 text-[12px] text-[#3f3124] outline-none transition placeholder:text-[#8d8d8d] focus:border-[#a65d1f] focus:ring-1 focus:ring-[#a65d1f]/25";

const textareaClassName =
  "min-h-[92px] w-full  rounded-xl border border-[#9d9d9d] bg-white px-3 py-2 text-[12px] text-[#3f3124] outline-none transition placeholder:text-[#8d8d8d] focus:border-[#a65d1f] focus:ring-1 focus:ring-[#a65d1f]/25";
...
// Convert select choices to CustomSelect options format
const createOptions = (choices: string[]) =>
      ...
      <section className="bg-[#e8ded1] px-4 pb-16 pt-14 sm:px-6 sm:pb-20 sm:pt-20 lg:px-8 xl:px-10">
          ...
          <form onSubmit={handleSubmit} noValidate className="px-4 pb-8 pt-3 sm:px-6 sm:pb-10 lg:px-8 lg:pb-12">
                ...
                <div className="max-w-140">
                  ...
                  <div className="mt-2">
                    <CustomSelect
                      ...
                      onChange={handleChange}
                      options={createOptions(selectChoices.experience)}
                      placeholder="Select"
                    />
                  </div>
            ...
            <div className="border-b border-[#d3d3d3] py-6 sm:py-8">
              <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_160px] xl:grid-cols-[minmax(0,1fr)_240px] xl:gap-8">
                <div>
                  ...
                  <div className="mt-4 grid gap-4 md:grid-cols-2 lg:max-w-170">
                    <div>
                      <p className="mb-2 text-[13px] leading-6 text-[#352b24]">
                      ...
                      <CustomSelect
                        ...
                        onChange={handleChange}
                        options={createOptions(selectChoices.minGroupSize)}
                        placeholder="Choose"
                      />
                    ...
                    <div>
                      ...
                      <CustomSelect
                        ...
                        onChange={handleChange}
                        options={createOptions(selectChoices.maxGroupSize)}
                        placeholder="Choose"
                      />
            ...
            <div className="border-b border-[#d3d3d3] py-6 sm:py-8">
              <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_160px] xl:grid-cols-[minmax(0,1fr)_240px] xl:gap-8">
                <div className="max-w-140">
                  ...
                  <div className="mt-4 grid gap-2 sm:grid-cols-[minmax(0,1fr)_150px] sm:items-end">
                    <div>
                      <p className="mb-2 text-[13px] leading-6 text-[#352b24]">
                      ...
                      <CustomSelect
                        ...
                        onChange={handleChange}
                        options={createOptions(selectChoices.dogPower)}
                        placeholder="Choose"
                      />
                    </div>
                    <div>
            ...
            <div className="border-b border-[#d3d3d3] py-6 sm:py-8">
              <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_160px] xl:grid-cols-[minmax(0,1fr)_240px] xl:gap-8">
                <div>
                  ...
                  <div className="mt-4 space-y-4 lg:max-w-105">
                    <div className="grid gap-2 grid-cols-1 sm:grid-cols-[86px_1fr] items-center md:grid-cols-[86px_minmax(0,1fr)_72px] lg:gap-3">
                      <label htmlFor="firstChoice" className="text-[13px] font-medium text-[#352b24]">1st Choice</label>
                      <div className="order-3 col-span-1 sm:order-2 sm:col-span-1 md:col-span-1">
                        <CustomSelect
                          name="firstChoice"
                          value={formData.firstChoice}
                          onChange={handleChange}
                          options={createOptions(selectChoices.timeframe)}
                          placeholder="Choose"
                        />
                        <ErrorText message={errors.firstChoice} />
                      </div>
                      <Link href="/availability" className="order-2 col-span-1 sm:order-3 sm:col-span-1 md:col-span-1 text-[11px] font-medium text-[#e3782f] underline-offset-2 hover:underline">
                        View Grid
                      </Link>
                    </div>
                    <div className="grid gap-2 grid-cols-1 sm:grid-cols-[86px_1fr] items-center md:grid-cols-[86px_minmax(0,1fr)_72px] lg:gap-3">
                      ...
                      <div className="order-3 col-span-1 sm:order-2 sm:col-span-1 md:col-span-1">
                        <CustomSelect
                          ...
                          onChange={handleChange}
                          options={createOptions(availableSecondChoices)}
                          placeholder="Choose"
                        />
            ...
            <div className="py-6 sm:py-8">
              ...
              <div className="mt-4 max-w-175 w-full">
