      ...
      <section className="bg-white px-4 py-16 sm:px-6 md:px-8">
        <div className="mx-auto max-w-6xl space-y-10">
          <div className="rounded-3xl border border-[#dfd3c8] bg-[#fbf2e8] p-8 shadow-sm">
            <h2 className="mb-4 text-2xl font-bold text-[#281703]">
              Payment Overview
            </h2>
            <p className="text-sm leading-7 text-[#4d3c2f]">
              UGUIDE deposits are processed securely via PayPal and are applied
              directly to your reservation. You can review your quote and make a
              deposit using the Quote-Reserve flow, or contact our team if you
              prefer assistance.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-3xl border border-[#dfd3c8] bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-7 text-[#4d3c2f]">
                A deposit secures your camp reservation and starts the booking
                process. The exact amount is calculated during quote submission.
              </p>
            </div>
            <div className="rounded-3xl border border-[#dfd3c8] bg-white p-6 shadow-sm">
              <h3 className="mb-3 text-lg font-bold text-[#281703]">
                Secure Checkout
              </h3>
              <p className="text-sm leading-7 text-[#4d3c2f]">
                Payments are processed through a secure PayPal integration. You
                do not need a PayPal account to complete checkout when using a
            ...
            <div className="rounded-3xl border border-[#dfd3c8] bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-7 text-[#4d3c2f]">
                If you need payment assistance, we are available to help you
                finalize your booking and confirm your selected week and camp.
              </p>
            </div>
          </div>
        </div>
